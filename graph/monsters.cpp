...
// places where the monsters can reach before the person, can be considered to be as good as blocked,
// so first run a multisource bfs with all the monsters to find the time taken to reach all non blocked cells by the monsters
// then run a bfs using the persons position to find the time taken by the person to reach there
// finally if there is any boundary cell such that the person can reach it before the monsters,.. then print the path to it
